...
#define DEF_TWO_PHASE_FREQUENCY			(1574400)
#define DBS_INPUT_EVENT_MIN_FREQ		(729600)
#define DEF_FREQUENCY_OPTIMAL			(1574400)
#define DEF_FREQ_DOWN_STEP			(550000)
#define DEF_FREQ_DOWN_STEP_BARRIER		(1574400)
#else
